...
class Tartarus extends GPRun {
    ...
    protected GPAdfNodeSet createNodeSet(GPVariables cfg) {
        ...
        GPNodeSet ns0 = new GPNodeSet(21);
        ...
        // New nodes
        ns0.putNode(new GPNode(Grid.RND, "rnd"));
        ns0.putNode(new GPNode(Grid.TWOAHEAD, "2ahd", 3));
        ns0.putNode(new GPNode(Grid.THREEAHEAD, "3ahd", 3));
